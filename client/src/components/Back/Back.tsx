...
function Back(props: BackProps) {
  ...
  return (
    <svg width="800px" height="800px" viewBox="0 0 1024 1024" onClick={() => navigate(props.to ?? -1 as any)} style={{ width: "1.8em", height: "1.8em", cursor: "pointer" }} xmlns="http://www.w3.org/2000/svg">
